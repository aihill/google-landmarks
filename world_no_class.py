...
__C.DATASETS.NO_CLASS.TRAIN_DIR = osp.join(__C.DATASETS.NO_CLASS.ROOT_DIR, 'train')   # run prepare_datasets.py to generate
__C.DATASETS.NO_CLASS.TEST_DIR = osp.join(__C.DATASETS.NO_CLASS.ROOT_DIR, 'test')     # run prepare_datasets.py to generate
